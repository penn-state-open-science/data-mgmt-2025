...
See [this page](data.qmd) for details about how these figures were generated.

:::: {.columns}
::: {.column width=50%}
![](include/fig/fig-registration-time-series-1.png)
:::
::: {.column width=50%}
![](include/fig/fig-registrations-college-position-1.png)
:::
::::
